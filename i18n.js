  ...
  const GANGA_I18N = {
    ...
    ui: {
      en: {
        ...
        contactPhoneLabel: 'Mobile / WhatsApp Number *',
        contactPhonePlaceholder: 'e.g. 98480 12345',
        contactVillageLabel: 'Village / Mandal / District *',
        contactVillagePlaceholder: 'e.g. Shetpalle, Nizamabad',
        contactCropLabel: 'Select Crop or Hybrid Variety *',
        ...
        contactBtnSubmit: 'Send Inquiry via WhatsApp',
      ...
      te: {
        ...
        contactNameLabel: 'మీ పూర్తి పేరు *',
        contactNamePlaceholder: 'ఉదా: రాజేందర్ రెడ్డి',
        contactPhoneLabel: 'మొబైల్ / వాట్సాప్ నంబర్ *',
        contactPhonePlaceholder: 'ఉదా: 98480 12345',
        contactVillageLabel: 'గ్రామం / మండలం / జిల్లా *',
        contactVillagePlaceholder: 'ఉదా: షెట్పల్లె, నిజామాబాద్',
        contactCropLabel: 'పంట లేదా హైబ్రిడ్ రకాన్ని ఎంచుకోండి *',
        ...
        contactBtnSubmit: 'వాట్సాప్ ద్వారా పంపండి',
