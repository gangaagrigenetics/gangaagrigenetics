  ...
  const GANGA_I18N = {
    ...
    ui: {
      en: {
        ...
        filterAll: 'All Seeds (13)',
        filterCereals: 'Cereals & Millets',
        filterOilseeds: 'Oilseeds & Pulses',
        filterBonus: '₹500 Bonus Sannalu (7)',
        activeFilterAll: 'Showing all {count} certified seed varieties',
        activeFilterCereals: 'Showing {count} Cereals & Millets varieties',
        activeFilterOilseeds: 'Showing {count} Oilseeds & Pulses varieties',
        activeFilterBonus: 'Showing {count} Telangana ₹500 Bonus Sannalu varieties',
        activeFilterSearch: 'Showing {count} varieties matching "{query}"',
        activeFilterSearchSingular: 'Showing 1 variety matching "{query}"',
        activeFilterGeneric: 'Showing {count} varieties',
        activeFilterGenericSingular: 'Showing 1 variety',
        varietyBadgeSingular: '1 Variety',
        varietyBadgePlural: '{count} Varieties',
        ...
        specYield: 'Yield Potential',
        specGermination: 'Germination',
        specSeedRate: 'Seed Rate',
        specSeason: 'Season',
        specGrainType: 'Grain Type',
        modalTraitHeading: 'Key Agronomic Traits & Description',
        modalSowingHeading: 'Sowing & Cultivation Guide',
        calcInputsHeading: 'Farm Parameters',
        resSeedLabel: 'Total Seed Required',
        resYieldLabel: 'Expected Yield Potential',
        resSpacingLabel: 'Recommended Spacing:',
        resDurationLabel: 'Maturity Duration:',
        resGerminationLabel: 'Germination Standard:',
        calcAdviceDefault: 'Apply balanced NPK (120:60:40 kg/ha). Maintain 2-3 cm shallow water in nursery beds for optimal tillering.',
        calcOrderBtnText: 'Order These Seeds on WhatsApp',
        calendarTag: 'Telangana Sowing Guide',
        catalogEmptyTitle: 'No Seed Varieties Found',
        catalogEmptyDesc: 'Try searching for a different keyword or reset the category filters above.',
        catalogEmptyBtn: 'Reset Filters',
        aboutDesc1: 'From our indigenous germplasm collection to multi-location field trials across diverse agro-climatic zones of Telangana, Andhra Pradesh, and Karnataka, our hybrids are engineered to withstand biotic stress (pests, blight, viruses) and abiotic stress (drought, heat, soil salinity).',
        aboutPurityTitle: '1. Genetic Purity',
        aboutPurityDesc: 'Rigorous grow-out tests ensure true-to-type seed genetics with zero rogue contamination.',
        aboutGerminationTitle: '2. High Germination',
        aboutGerminationDesc: 'Standard and cold-stress germination testing guarantees 96-98% field emergence viability.',
        aboutTreatmentTitle: '3. Polymer Seed Coating',
        aboutTreatmentDesc: 'Fungicide and micronutrient polymer film coating protects emerging seedlings against early soil pathogens.',
      ...
      te: {
        ...
        filterAll: 'అన్ని విత్తనాలు (13)',
        filterCereals: 'ధాన్యాలు & మిల్లెట్స్',
        filterOilseeds: 'నూనెగింజలు & పప్పుధాన్యాలు',
        filterBonus: '₹500 బోనస్ సన్నాలు (7)',
        activeFilterAll: 'మొత్తం {count} సర్టిఫైడ్ విత్తన రకాలను చూపుతోంది',
        activeFilterCereals: 'వరి & తృణధాన్యాల {count} రకాలను చూపుతోంది',
        activeFilterOilseeds: 'నూనెగింజలు & పప్పుధాన్యాల {count} రకాలను చూపుతోంది',
        activeFilterBonus: '₹500 బోనస్ గల {count} సన్న బియ్యం రకాలను చూపుతోంది',
        activeFilterSearch: '"{query}" కోసం {count} రకాలను చూపుతోంది',
        activeFilterSearchSingular: '"{query}" కోసం 1 రకాన్ని చూపుతోంది',
        activeFilterGeneric: '{count} రకాలను చూపుతోంది',
        activeFilterGenericSingular: '1 రకాన్ని చూపుతోంది',
        varietyBadgeSingular: '1 రకం',
        varietyBadgePlural: '{count} రకాలు',
        ...
        specDuration: 'పంట కాలం',
        specYield: 'దిగుబడి సామర్థ్యం',
        specGermination: 'మొలక శాతం',
        specSeedRate: 'విత్తన మోతాదు',
        specSeason: 'అనుకూల కాలం',
        specGrainType: 'గింజ రకం',
        modalTraitHeading: 'ముఖ్యమైన లక్షణాలు & వివరణ',
        modalSowingHeading: 'సాగు మరియు యాజమాన్య పద్ధతులు',
        calcInputsHeading: 'పొలం వివరాలు',
        resSeedLabel: 'అవసరమైన మొత్తం విత్తనాలు',
        resYieldLabel: 'అంచనా దిగుబడి సామర్థ్యం',
        resSpacingLabel: 'సిఫార్సు చేసిన దూరం:',
        resDurationLabel: 'పంట కాల పరిమితి:',
        resGerminationLabel: 'ధ్రువీకృత మొలక శాతం:',
        calcAdviceDefault: 'సమతుల్య ఎరువుల వాడకం (NPK 120:60:40 kg/ha). పిలకలు బాగా వేయడానికి నారుమడిలో 2-3 సెం.మీ తక్కువ నీటిని నిర్వహించండి.',
        calcOrderBtnText: 'ఈ విత్తనాలను వాట్సాప్‌లో ఆర్డర్ చేయండి',
        calendarTag: 'తెలంగాణ విత్తన క్యాలెండర్',
        catalogEmptyTitle: 'విత్తన రకాలు కనుగొనబడలేదు',
        catalogEmptyDesc: 'వేరే పేరుతో శోధించండి లేదా పై ఫిల్టర్లను రీసెట్ చేయండి.',
        catalogEmptyBtn: 'ఫిల్టర్లను రీసెట్ చేయండి',
        aboutDesc1: 'తెలంగాణ, ఆంధ్రప్రదేశ్ మరియు కర్ణాటక రాష్ట్రాల వివిధ వాతావరణ పరిస్థితులలో విస్తృతంగా క్షేత్ర పరిశోధనలు నిర్వహించి, పురుగులు, తెగుళ్లు మరియు వర్షాభావ పరిస్థితులను తట్టుకునే మేలు రకపు హైబ్రిడ్ విత్తనాలను రైతులకు అందిస్తున్నాము.',
        aboutPurityTitle: '1. జన్యు స్వచ్ఛత',
        aboutPurityDesc: 'కల్తీ లేని అసలైన జన్యు స్వచ్ఛత కోసం కఠినమైన గ్రో-అవుట్ పరీక్షలు.',
        aboutGerminationTitle: '2. అధిక మొలక శాతం',
        aboutGerminationDesc: 'ప్రతి లాట్‌లో 96-98% గ్యారెంటీ మొలక శాతం కోసం క్లైమేట్ చాంబర్ పరీక్షలు.',
        aboutTreatmentTitle: '3. పాలిమర్ విత్తన శుద్ధి',
        aboutTreatmentDesc: 'మొలకెత్తే దశలో నేల ద్వారా వచ్చే తెగుళ్లను నిరోధించడానికి బయో-పాలిమర్ కోటింగ్.',
